...
// Protocol schema for active-users overview responses
export const activeUsersProtocolSchema = z.object({
  name: z.string(),
...
export const activeUsersOverviewResponseSchema = z.object({
  protocols: z.array(activeUsersProtocolSchema).optional(),
...
export const activeUsersSummaryResponseSchema = z.object({
  id: z.string().optional().nullable(),
  name: z.string(),
